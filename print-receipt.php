...
<div class="container my-5">
    <div class="card shadow-sm">
        ...
        <div class="card-body p-4">
            ...
            <p>Thank you for your booking. Please present this receipt when you register at the campsite.</p>
            <hr>
            ...
            <table class="table table-borderless">
                ...
                <?php if ($booking['payment_status'] === 'paid' && empty($booking['receipt_path'])): ?>
                    <tr><td colspan="2"><em>Payment was collected at the campsite upon arrival (walk‑in).</em></td></tr>
                <?php endif; ?>
            </table>
            ...
            <div class="alert alert-info mt-3" style="background-color: #e8d9c5; border-color: #dcc9b5; color: #5e4b3a;">
                <i class="fas fa-info-circle"></i> Please bring this receipt (digital or printed) when you arrive. Check‑in after 3:00 PM, check‑out before 12:00 PM.
            </div>
        </div>
        <div class="card-footer text-center bg-white">
            ...
            <a href="manage-reservations.php" class="btn btn-secondary ms-2">Back to Reservations</a>
        </div>
    </div>
</div>
