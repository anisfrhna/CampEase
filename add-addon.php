...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || $price <= 0) {
        ...
        if ($stmt->execute([$name, $price, $status])) {
...
<div class="form-card">
    <div class="form-header d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
        <h3><i class="fas fa-plus-circle me-2 text-success"></i>Add New Add-on</h3>
    ...
    <form method="POST">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Save Add-on</button>
