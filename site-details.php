...
<div class="container my-5">
    <div class="row">
        <div class="col-lg-8">
            <!-- Campsite name with Italianno font -->
            <h1 style="font-family: 'Italianno', cursive; font-size: 3rem;"><?= htmlspecialchars($site['name']) ?></h1>
            ...
            <div class="alert alert-info mt-3">
                <i class="fas fa-clock"></i> <strong>Check‑in / Check‑out times:</strong> Check‑in after 3:00 PM, check‑out before 12:00 PM.
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <p><strong>Check-in:</strong> <?= date('d M Y', strtotime($check_in)) ?> (after 3:00 PM)</p>
                        <p><strong>Check-out:</strong> <?= date('d M Y', strtotime($check_out)) ?> (before 12:00 PM)</p>
